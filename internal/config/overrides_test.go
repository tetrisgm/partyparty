...
func TestParseOverridesValid(t *testing.T) {
	raw := []byte(`{"server":{"bitrate":"256k","channels":1,"hlsTimeSec":2,"hlsListLen":30,"partDur":"500ms","segDur":"3s","segCount":10}}`)
	...
	if got.Bitrate != "256k" || got.Channels != 1 || got.PartDur != "500ms" || got.SegCount != 10 {
...
func TestParseOverridesRejectsUnsafe(t *testing.T) {
	...
	for _, raw := range cases {
		...
		if o.Bitrate != nil || o.Channels != nil || o.HLSTime != nil || o.HLSList != nil ||
			o.PartDur != nil || o.SegDur != nil || o.SegCount != nil {
