...
const joinBegin = page.indexOf('    function createNativeJoin(');
const joinEnd = page.indexOf('    let nativeJoinTimer', joinBegin);
if (joinBegin < 0 || joinEnd < 0) throw new Error('listener native join controller not found');
export const createNativeJoin = new Function(page.slice(joinBegin, joinEnd) + '\nreturn createNativeJoin;')();
