...
03:01:20.000 | ev[iPhone A | 192.168.1.10 cid-a.tab-a v115.87 guest] gov-seek +18900ms #3 lat=1.8 late=0.8 before=20 want=20.8
03:01:20.010 | ev[iPhone A | 192.168.1.10 cid-a.tab-a v115.87 guest] audible-seek +18910ms #4 pos=20.8 lat=1 app=true
`;
