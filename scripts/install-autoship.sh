...
set -euo pipefail
cd "$(dirname "$0")/.."
PLIST_SRC="deploy/autoship/party.partyparty.autoship.plist"
PLIST_DST="$HOME/Library/LaunchAgents/party.partyparty.autoship.plist"
LABEL="party.partyparty.autoship"
